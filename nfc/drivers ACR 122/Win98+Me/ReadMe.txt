ACR122U PC/SC Driver Installer 1.1.6.2 (MSI)
...
5. To remove the driver, please select the Uninstall shortcut in program group or go to "Add or Remove Programs" in Control Panel.
...
v1.1.1.0 (25/2/2009)
1. Add ACS CCID driver v1.1.6.3 in order to support ACR122U reader (PID: 90CC).

v1.1.1.0 (28/7/2009)
1. Update driver to v1.1.6.4 (PID: 90CC).
...
|
\---x86_nonwin2k
        ACR122U_PCSC_Driver-1.1.6.2.msi
        Arabic.mst
